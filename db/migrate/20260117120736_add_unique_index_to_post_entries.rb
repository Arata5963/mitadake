# db/migrate/20260117120736_add_unique_index_to_post_entries.rb
# ==========================================
# エントリーにユニークインデックスを追加
# ==========================================
#
# 【このマイグレーションの目的】
# 同一ユーザーが同一動画に複数のアクティブなエントリーを
# 持つことを防ぐため、user_id + post_id のユニーク制約を追加する。
#
# 【処理内容】
# 1. 重複エントリーを検出（user_id + post_id が同じもの）
# 2. 最新以外の重複エントリーに紐づくentry_flamesを削除
# 3. 最新以外の重複エントリーを削除
# 4. ユニークインデックスを追加
#
# 【注意】
# - 重複データがある場合、最新のもの以外は削除される
#
# ==========================================
