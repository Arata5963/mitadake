...
main_user = User.create!(
  ...
  name: "あらた",
  favorite_quote: "継続は力なり。毎日少しずつでも前に進もう。",
  favorite_quote_url: "https://www.youtube.com/watch?v=dQw4w9WgXcQ",
...
users = []
user_data = [
  { name: "さくら", quote: "夢は逃げない。逃げるのはいつも自分だ。", avatar_id: 5 },
  { name: "ゆうき", quote: "失敗を恐れるな、挑戦しないことを恐れろ。", avatar_id: 33 },
  { name: "はると", quote: "今日という日は、残りの人生の最初の日。", avatar_id: 51 },
  { name: "めい", quote: "小さな一歩が大きな変化を生む。", avatar_id: 9 },
  { name: "そうた", quote: nil, avatar_id: 60 }
]
...
user_data.each_with_index do |data, i|
  users << User.create!(
    ...
    password: "password123",
    name: data[:name],
    favorite_quote: data[:quote],
    favorite_quote_url: data[:quote] ? "https://www.youtube.com/watch?v=example#{i}" : nil,
